...
namespace NFCReader.Controls
{
    public partial class NdefHeaderSection : UserControl
    {
        enum SectionStatus
        {
            Closed,
        ...
        public NdefHeaderSection(String title, String text)
        {
        ...
        public NdefHeaderSection(String title, List<String> text)
        {
            init();
            Title.Title = title;
